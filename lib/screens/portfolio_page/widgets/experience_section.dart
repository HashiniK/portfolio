  ...
  List<ExperienceItem> _getExperienceData() {
    return [
      ExperienceItem(
        ...
        isCurrent: true,
        points: [
          'Leading mobile development for a restaurant operations management platform serving multinational clients across the Middle East, deployed on iOS App Store and Google Play Store',
          'Architected a lifecycle-aware provider system achieving 5x faster startup times and 60% memory reduction through optimized state management and lazy initialization',
          'Resolved thousands of Sentry production errors through systematic debugging, provider scope optimization, and widget tree hierarchy refinement',
          'Built and maintained 8+ operational modules including digital checklists, task management, approvals, inspections, and asset management with role-based permissions',
          'Delivered multilingual support with full RTL layout handling for Arabic, including Eastern Arabic numerals and mixed LTR/RTL expressions',
          'Managed the complete release pipeline for iOS (TestFlight) and Android (Play Store) with obfuscated builds and Sentry symbol uploads',
        ],
        keyProjects: [
          'Restaurant Operations Platform – Multi-brand, multi-branch management system with dynamic data scoping',
          'Pagination Infrastructure – Implemented across Forms, Tasks, Inspections, and Approvals modules',
        ],
      ),
      ExperienceItem(
        ...
        isCurrent: false,
        points: [
          'Built scalable web and Android applications using Flutter and Dart, delivering domestic and international projects',
          'Focused on responsive UI, clean architecture, and performance optimization across multiple client engagements',
          'Developed no-code Rule Builder and Form Builder tools, reducing development time by 40% for client onboarding',
        ...
        keyProjects: [
          ...
          'Communication Composer – Dynamic client communications management tool',
          'Strategy Builder – Visual interface for creating business logic and decision trees',
          'SmartPortal – Centralized dashboard for user access, analytics, and service monitoring',
          'Microservice Dashboard – Real-time service health monitoring with severity filters and alerts',
        ],
      ),
      ExperienceItem(
        ...
        isCurrent: false,
        points: [
          'Built dynamic form-driven applications using Flutter and Dart, focusing on metadata-based automation, scalable architecture, and reusable components',
          'Designed a JSON-driven Form Builder enabling dynamic form creation and automated application generation',
          'Contributed to modular UI components, data binding logic, and backend integrations',
          'Used by international clients to accelerate onboarding, improve efficiency, and support no-code solutions',
        ],
        keyProjects: [
          'Form Builder – JSON-driven platform enabling dynamic form creation and automated application generation',
        ],
      ),
      ExperienceItem(
        ...
        keyProjects: [
          ...
          'SmartCollect – Mobile solution for RDB Bank agents with offline support and real-time sync',
        ],
      ),
    ];
  }
